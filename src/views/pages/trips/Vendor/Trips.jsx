...
export default function VTripsBookings() {
  ...
  useEffect(() => {
    const storedOps = JSON.parse(localStorage.getItem("voperations")) || [];
...
const getStatusBadge = (status) => {
  ...
  const handleNewRequest = () => navigate("/vendor/newrequest");
