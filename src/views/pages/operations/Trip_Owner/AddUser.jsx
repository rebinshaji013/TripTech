...
export default function TripOwnerDetails() {
  ...
  const handleSaveUser = (e) => {
    ...
    const existingUsers = JSON.parse(localStorage.getItem("owneroperations") || "[]");
    ...
    navigate("/owner/operations"); // go back to listing page
  };
        ...
        <CCardBody>
          <CForm onSubmit={handleSaveUser}>
            ...
            <CRow className="mb-3">
              ...
              <CCol md={6}>
                <CFormLabel htmlFor="location">User email ID</CFormLabel>
                <CFormInput
                 id="email"
                 name="email"
